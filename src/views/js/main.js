...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    switch(size) {
      case "1":
        randomPizzas.classList.add("small");
        randomPizzas.classList.remove("large");
        break;
      case "2":
        randomPizzas.classList.remove("small");
        randomPizzas.classList.remove("large");
        break;
      case "3":
        randomPizzas.classList.add("large");
        randomPizzas.classList.remove("small");
        break;
      default:
...
for (var i = 2; i < 100; i++) {
  randomPizzas.appendChild(newPizzaElementGenerator(i));
}
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0, elem, num = rows*cols; i < num; i++) {
